...
.. php:class:: php\\lib\\str
 ...
 .. php:staticmethod:: pos($string, $search, $fromIndex = 0)
  ...
  :param $search: 
  :param $fromIndex: 
  :returns: :doc:`int </api/int>` - returns -1 if not found
 ...
 .. php:staticmethod:: lastPos($string, $search, $fromIndex = null)
  ...
  :param $string: 
  :param $search: 
  :param $fromIndex: :doc:`null </api/null>`, :doc:`int </api/int>` - null means $fromIndex will be equal $string.length
  :returns: :doc:`int </api/int>` - returns -1 if not found
 ...
 .. php:staticmethod:: sub($string, $beginIndex, $endIndex = null)
  ...
  :param $beginIndex: 
  :param $endIndex: 
  :returns: :doc:`string </api/string>` - return false if params are invalid
 ...
 .. php:staticmethod:: split($string, $separator, $limit = 0)
  ...
  :param $separator: 
  :param $limit: 
  :returns: :doc:`php\\util\\Cursor </api/php/util/Cursor>` 
