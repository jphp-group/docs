...
.. php:class:: php\\swing\\Image
 ...
 .. php:method:: setRGB($x, $y, $rgb)
  ...
  :param $x: 
  :param $y: 
  :param $rgb: :doc:`int </api_ru/int>` - color
 ...
 .. php:method:: getProperty($name)
  ...
  :param $name: 
  :returns: :doc:`php\\lang\\JavaObject </api_ru/php/lang/JavaObject>`, :doc:`null </api_ru/null>` 

 .. php:staticmethod:: read($stream)

  :param $stream: :doc:`php\\io\\Stream </api_ru/php/io/Stream>`, :doc:`php\\io\\File </api_ru/php/io/File>`, :doc:`string </api_ru/string>` - file path or stream
  :returns: :doc:`php\\swing\\Image </api_ru/php/swing/Image>` 
