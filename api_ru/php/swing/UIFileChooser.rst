...
----------
 ...
 .. php:method:: onFileView($field, $callback = null)
  ...
  :param $field: :doc:`string </api_ru/.types/string>`  - - name (string), description (string), icon (Image), traversable (bool)
  :param $callback: :doc:`callable </api_ru/.types/callable>`  - (File $file)
