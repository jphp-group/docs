...
----------
 ...
 .. php:method:: drawArc($x, $y, $width, $height, $startAngle, $arcAngle)
  ...
  :param $width: :doc:`int </api_ru/.types/int>` 
  :param $height: :doc:`int </api_ru/.types/int>` 
  :param $startAngle: :doc:`int </api_ru/.types/int>` 
  :param $arcAngle: :doc:`int </api_ru/.types/int>` 
 ...
 .. php:method:: drawImage($image, $x = 0, $y = 0, $newWidth = null, $newHeight = null)
  ...
  :param $x: :doc:`int </api_ru/.types/int>` 
  :param $y: :doc:`int </api_ru/.types/int>` 
  :param $newWidth: :doc:`null </api_ru/.types/null>`, :doc:`int </api_ru/.types/int>` 
  :param $newHeight: :doc:`null </api_ru/.types/null>`, :doc:`int </api_ru/.types/int>` 
 ...
 .. php:method:: setXORMode($color)
  ...
  :param $color: :doc:`php\\swing\\Color </api_ru/php/swing/Color>`, :doc:`int </api_ru/.types/int>`, :doc:`array </api_ru/.types/array>` 
 ...
 .. php:method:: copyArea($x, $y, $width, $height, $dx, $dy)
  ...
  :param $width: :doc:`int </api_ru/.types/int>` 
  :param $height: :doc:`int </api_ru/.types/int>` 
  :param $dx: :doc:`int </api_ru/.types/int>` 
  :param $dy: :doc:`int </api_ru/.types/int>` 

 .. php:method:: create($x = null, $y = null, $w = null, $h = null)

  Create new copy Graphics from this

  :param $x: :doc:`int </api_ru/.types/int>`, :doc:`null </api_ru/.types/null>` 
  :param $y: :doc:`int </api_ru/.types/int>`, :doc:`null </api_ru/.types/null>` 
  :param $w: :doc:`int </api_ru/.types/int>`, :doc:`null </api_ru/.types/null>` 
  :param $h: :doc:`int </api_ru/.types/int>`, :doc:`null </api_ru/.types/null>` 
