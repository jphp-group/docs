...
.. include:: /api_ru.desc/php/net/URLConnection.header.rst
...
----------
 ...
 .. php:method:: setConnectTimeout($timeout)
  ...
  :param $timeout: :doc:`int </api_ru/.types/int>`  - that specifies the connect timeout value in milliseconds
 ...
 .. php:method:: getContentLength()
  ...
  :returns: :doc:`int </api_ru/.types/int>` the content length of the resource that this connection's URL
 ...
 .. php:method:: setDoInput($doinput)
  ...
  :param $doinput: :doc:`bool </api_ru/.types/bool>` 
 ...
 .. php:method:: setUseCaches($useCaches)
  ...
  :param $useCaches: :doc:`bool </api_ru/.types/bool>` 
 ...
 .. php:method:: setIfModifiedSince($ifmodifiedsince)
  ...
  :param $ifmodifiedsince: :doc:`int </api_ru/.types/int>` 
 ...
 .. php:method:: setChunkedStreamingMode($chunklen)
  ...
  :param $chunklen: :doc:`int </api_ru/.types/int>`  - The number of bytes to write in each chunk.
 ...
 .. php:method:: setRequestMethod($method)
  ...
  :param $method: :doc:`string </api_ru/.types/string>` 
 ...
 .. php:staticmethod:: guessContentTypeFromStream($stream)
  ...
  :param $stream: :doc:`php\\io\\Stream </api_ru/php/io/Stream>` 
  :returns: :doc:`string </api_ru/.types/string>` 
...
.. include:: /api_ru.desc/php/net/URLConnection.footer.rst
