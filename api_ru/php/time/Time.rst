...
.. include:: /api_ru.desc/php/time/Time.header.rst
...
----------
 ...
 .. php:method:: __construct($date, $timezone = null)
  ...
  :param $date: :doc:`int </api_ru/.types/int>`  - unix long timestamp (in millis)
  :param $timezone: :doc:`php\\time\\TimeZone </api_ru/php/time/TimeZone>`  - - if null then gets default timezone
 ...
 .. php:method:: replace($args)
  ...
  :param $args: :doc:`array </api_ru/.types/array>`  - [millis, sec, min, hour, day, month, year]
  :returns: :doc:`php\\time\\Time </api_ru/php/time/Time>` 
 ...
 .. php:method:: toString($format)
  ...
  :param $format: :doc:`string </api_ru/.types/string>`  - date time format
 ...
 .. php:staticmethod:: of($args, $timeZone = null)
  ...
  :param $args: :doc:`array </api_ru/.types/array>`  - [millis, sec, min, hour, day, month, year]
  :param $timeZone: :doc:`php\\time\\TimeZone </api_ru/php/time/TimeZone>`  - if null then it uses the default timezone
  :returns: :doc:`php\\time\\Time </api_ru/php/time/Time>` 
...
.. include:: /api_ru.desc/php/time/Time.footer.rst
