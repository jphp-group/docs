...
.. include:: /api_ru.desc/php/gdx/files/FileHandle.header.rst
...
----------
 ...
 .. php:method:: __construct($path)
  ...
  :param $path: :doc:`string </api_ru/.types/string>`, :doc:`php\\io\\File </api_ru/php/io/File>` 
 ...
 .. php:method:: readString($charset)
  ...
  :param $charset: :doc:`string </api_ru/.types/string>`  - (optional)
  :returns: :doc:`string </api_ru/.types/string>` 

 .. php:method:: readBytes()

  :returns: :doc:`string </api_ru/.types/string>` binary

 .. php:method:: write($append, $bufferSize)

  :param $append: :doc:`bool </api_ru/.types/bool>` 
  :param $bufferSize: :doc:`int </api_ru/.types/int>`  - (optional)
  :returns: :doc:`php\\io\\Stream </api_ru/php/io/Stream>` 
 ...
 .. php:method:: writeBytes($binaryString, $append)
  ...
  :param $binaryString: :doc:`string </api_ru/.types/string>` 
  :param $append: :doc:`bool </api_ru/.types/bool>` 

 .. php:method:: getList($suffix)

  :param $suffix: :doc:`string </api_ru/.types/string>`  - (optional)
  ...
  **throws** :doc:`php\\gdx\\files\\\\Exception </api_ru/php/gdx/files//Exception>`
 ...
 .. php:method:: emptyDirectory($preserveTree)
  ...
  :param $preserveTree: :doc:`bool </api_ru/.types/bool>`  - (optional)
...
.. include:: /api_ru.desc/php/gdx/files/FileHandle.footer.rst
