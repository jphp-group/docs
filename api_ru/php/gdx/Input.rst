...
.. include:: /api_ru.desc/php/gdx/Input.header.rst
...
----------
 ...
 .. php:method:: getAccelerometerX()
  ...
  :returns: :doc:`double </api_ru/.types/double>` The value of the accelerometer on its x-axis. ranges between [-10,10].

 .. php:method:: getAccelerometerY()

  :returns: :doc:`double </api_ru/.types/double>` The value of the accelerometer on its y-axis. ranges between [-10,10].
 ...
 .. php:method:: getX($pointer)
  ...
  :param $pointer: :doc:`int </api_ru/.types/int>`  - (optional) the pointer id. Returns the x coordinate in screen coordinates of the given pointer.
  :returns: :doc:`int </api_ru/.types/int>` 

 .. php:method:: getDeltaX($pointer)

  :param $pointer: :doc:`int </api_ru/.types/int>`  - (optional) the pointer id.
  :returns: :doc:`int </api_ru/.types/int>` the different between the current pointer location and the last pointer location on the x-axis.
 ...
 .. php:method:: getY($pointer)
  ...
  :param $pointer: :doc:`int </api_ru/.types/int>`  - (optional) the pointer id. Returns the y coordinate in screen coordinates of the given pointer.
  :returns: :doc:`int </api_ru/.types/int>` 

 .. php:method:: getDeltaY($pointer)

  :param $pointer: :doc:`int </api_ru/.types/int>`  - (optional) the pointer id.
  :returns: :doc:`int </api_ru/.types/int>` the different between the current pointer location and the last pointer location on the y-axis.

 .. php:method:: isTouched($pointer)

  :param $pointer: :doc:`int </api_ru/.types/int>`  - (optional)
  :returns: :doc:`bool </api_ru/.types/bool>` whether the screen is currently touched.

 .. php:method:: justTouched()

  :returns: :doc:`bool </api_ru/.types/bool>` whether a new touch down event just occurred.
 ...
 .. php:method:: isButtonPressed($button)
  ...
  :param $button: :doc:`int </api_ru/.types/int>` 
 ...
 .. php:method:: isKeyPressed($key)
  ...
  :param $key: :doc:`int </api_ru/.types/int>` 

 .. php:method:: setOnscreenKeyboardVisible($visible)

  Sets the on-screen keyboard visible if available.

  :param $visible: :doc:`bool </api_ru/.types/bool>` 
 ...
 .. php:method:: vibrate($millis)
  ...
  :param $millis: :doc:`int </api_ru/.types/int>`  - the number of milliseconds to vibrate.
 ...
 .. php:method:: getCurrentEventTime()
  ...
  :returns: :doc:`int </api_ru/.types/int>` the time of the event currently reported to the InputProcessor.
 ...
 .. php:method:: setCatchBackKey($catchBack)
  ...
  :param $catchBack: :doc:`bool </api_ru/.types/bool>` 
 ...
 .. php:method:: setCatchMenuKey($catchMenu)
  ...
  :param $catchMenu: :doc:`bool </api_ru/.types/bool>` 

 .. php:method:: getRotation()

  :returns: :doc:`int </api_ru/.types/int>` the rotation of the device with respect to its native orientation.

 .. php:method:: getNativeOrientation()

  :returns: :doc:`string </api_ru/.types/string>` the native orientation of the device.
 ...
 .. php:method:: setCursorCatched($catched)
  ...
  :param $catched: :doc:`bool </api_ru/.types/bool>`  - whether to catch or not to catch the mouse cursor

 .. php:method:: isCursorCatched()

  :returns: :doc:`bool </api_ru/.types/bool>` whether the mouse cursor is catched.
 ...
 .. php:method:: setCursorImage($pixmap, $xHotspot, $yHotspot)
  ...
  :param $xHotspot: :doc:`int </api_ru/.types/int>` 
  :param $yHotspot: :doc:`int </api_ru/.types/int>` 



.. include:: /api_ru.desc/php/gdx/Input.footer.rst
