...
.. php:class:: php\\lib\\str
 ...
 .. php:staticmethod:: pos($string, $search, $fromIndex = 0)
  ...
  :param $search: 
  :param $fromIndex: 
  :returns: :doc:`int </api_en/int>` - returns -1 if not found
 ...
 .. php:staticmethod:: lastPos($string, $search, $fromIndex = null)
  ...
  :param $string: 
  :param $search: 
  :param $fromIndex: :doc:`null </api_en/null>`, :doc:`int </api_en/int>` - null means $fromIndex will be equal $string.length
  :returns: :doc:`int </api_en/int>` - returns -1 if not found
 ...
 .. php:staticmethod:: sub($string, $beginIndex, $endIndex = null)
  ...
  :param $beginIndex: 
  :param $endIndex: 
  :returns: :doc:`string </api_en/string>` - return false if params are invalid
