...
.. include:: /api_en.desc/php/gdx/math/Polyline.header.rst
...
----------
 ...
 .. php:method:: __construct($vertices)
  ...
  :param $vertices: :doc:`array </api_en/.types/array>`  - (optional)
 ...
 .. php:method:: getTransformedVertices()
  ...
  :returns: :doc:`float[] </api_en/.types/float>` vertices scaled, rotated, and offset by the polyline position.

 .. php:method:: getLength()

  :returns: :doc:`float </api_en/.types/float>` Returns the euclidean length of the polyline without scaling

 .. php:method:: getScaledLength()

  :returns: :doc:`float </api_en/.types/float>` Returns the euclidean length of the polyline
 ...
 .. php:method:: setOrigin($originX, $originY)
  ...
  :param $originX: :doc:`float </api_en/.types/float>` 
  :param $originY: :doc:`float </api_en/.types/float>` 
 ...
 .. php:method:: setPosition($x, $y)
  ...
  :param $y: :doc:`float </api_en/.types/float>` 

 .. php:method:: setVertices($vertices)

  :param $vertices: :doc:`array </api_en/.types/array>` 
 ...
 .. php:method:: setScale($scaleX, $scaleY)
  ...
  :param $scaleX: :doc:`float </api_en/.types/float>` 
  :param $scaleY: :doc:`float </api_en/.types/float>` 

 .. php:method:: scale($amount)

  Applies additional scaling to the polyline by the supplied amount.

  :param $amount: :doc:`float </api_en/.types/float>` 
...
.. include:: /api_en.desc/php/gdx/math/Polyline.footer.rst
