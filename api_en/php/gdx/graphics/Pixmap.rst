...
.. include:: /api_en.desc/php/gdx/graphics/Pixmap.header.rst
...
----------
 ...
 .. php:method:: __construct($width, $height, $format)
  ...
  :param $format: :doc:`string </api_en/.types/string>`  - - Alpha, Intensity, LuminanceAlpha, RGB565, RGBA4444, RGB888, RGBA8888
 ...
 .. php:method:: setColor($redOrColor, $g, $b, $a)
  ...
  :param $redOrColor: :doc:`double </api_en/.types/double>`, :doc:`int </api_en/.types/int>` 
  :param $g: :doc:`double </api_en/.types/double>`  - (optional)
  :param $b: :doc:`double </api_en/.types/double>`  - (optional)
  :param $a: :doc:`double </api_en/.types/double>`  - (optional)
 ...
 .. php:method:: drawPixmap($pixmap, $x, $y, $srcx, $srcy, $srcWidth, $srcHeight)
  ...
  :param $x: :doc:`int </api_en/.types/int>` 
  :param $y: :doc:`int </api_en/.types/int>` 
  :param $srcx: :doc:`int </api_en/.types/int>`  - (optional)
  :param $srcy: :doc:`int </api_en/.types/int>`  - (optional)
  :param $srcWidth: :doc:`int </api_en/.types/int>`  - (optional)
  :param $srcHeight: :doc:`int </api_en/.types/int>`  - (optional)
 ...
 .. php:method:: drawCircle($x, $y, $radius)
  ...
  :param $x: :doc:`int </api_en/.types/int>` 
  :param $y: :doc:`int </api_en/.types/int>` 
  :param $radius: :doc:`int </api_en/.types/int>` 
 ...
 .. php:method:: fillTriangle($x1, $y1, $x2, $y2, $x3, $y3)
  ...
  :param $x2: :doc:`int </api_en/.types/int>` 
  :param $y2: :doc:`int </api_en/.types/int>` 
  :param $x3: :doc:`int </api_en/.types/int>` 
  :param $y3: :doc:`int </api_en/.types/int>` 

 .. php:method:: getPixel($x, $y)

  :param $x: :doc:`int </api_en/.types/int>` 
  :param $y: :doc:`int </api_en/.types/int>` 
  :returns: :doc:`int </api_en/.types/int>` The pixel color in RGBA8888 format.
 ...
 .. php:method:: drawPixel($x, $y, $color)
  ...
  :param $x: :doc:`int </api_en/.types/int>` 
  :param $y: :doc:`int </api_en/.types/int>` 
  :param $color: :doc:`int </api_en/.types/int>`  - (optional)

 .. php:method:: getGLFormat()

  :returns: :doc:`int </api_en/.types/int>` one of GL_ALPHA, GL_RGB, GL_RGBA, GL_LUMINANCE, or GL_LUMINANCE_ALPHA.
 ...
 .. php:method:: getGLType()
  ...
  :returns: :doc:`int </api_en/.types/int>` one of GL_UNSIGNED_BYTE, GL_UNSIGNED_SHORT_5_6_5, GL_UNSIGNED_SHORT_4_4_4_4
